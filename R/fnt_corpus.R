...
#'
#' For spaCy or Trankit parsing instead, see \code{parse_text_spacy()} /
#' \code{parse_text_trankit()} in the companion \code{alsi-ai} package
#' (Python-backed, via \pkg{reticulate}).
#'
